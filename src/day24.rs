...
impl Problem<String, String, u32, usize, 24> for Day24 {
    fn first(contents: String) -> u32 {
        ...
        loop {
            let br = (b & 0b01111_01111_01111_01111_01111_u32) << 1;
            let bl = (b & 0b11110_11110_11110_11110_11110_u32) >> 1;
            let bd = (b & 0b00000_11111_11111_11111_11111_u32) << 5;
            let bu = (b & 0b11111_11111_11111_11111_00000_u32) >> 5;
            b = br & !bl & !bd & !bu
                | !br & bl & !bd & !bu
                | !br & !bl & bd & !bu
                | !br & !bl & !bd & bu
